...
class TestHBNBCommand_prompt(unittest.TestCase):
    '''     Unittests for testing prompt of the console. '''

    def test_prompt_string(self):
        self.assertEqual("(hbnb) ", HBNBCommand.prompt)

    def test_empty_line(self):
        with patch("sys.stdout", new=StringIO()) as display:
            self.assertFalse(HBNBCommand().onecmd(""))
            self.assertEqual("", display.getvalue().strip())


class TestHBNBCommand_help(unittest.TestCase):
    ''' Unittests for testing help messages of the console. '''

    def test_help_quit(self):
        comm = "Quit command to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help quit"))
            self.assertEqual(comm, output.getvalue().strip())

    def test_help_create(self):
        comm = ("Usage: create <class>\n        "
    ...
    def test_help_EOF(self):
        comm = "EOF signal to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(comm, output.getvalue().strip())

    def test_help_show(self):
        comm = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
    ...
    def test_help_destroy(self):
        comm = ("Usage: destroy <class> <id> or <class>.destroy(<id>)\n        "
    ...
    def test_help_all(self):
        comm = ("Usage: all or all <class> or <class>.all()\n        "
    ...
    def test_help_count(self):
        comm = ("Usage: count <class> or <class>.count()\n        "
    ...
    def test_help_update(self):
        comm = ("Usage: update <class> <id> <attribute_name> <attribute_value> or"
    ...
    def test_help(self):
        comm = ("Documented commands (type help <topic>):\n"
             "========================================\n"
...
class TestHBNBCommand_create(unittest.TestCase):
    ''' Class to test create from the HBNB command interpreter. '''
